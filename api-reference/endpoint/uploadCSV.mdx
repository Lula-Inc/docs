...
<Accordion title="Validation rules">
    ...
    <ResponseField name="description" type="string">
        ...
        <Warning>Minimum allowed description length: 350 characters</Warning>
    </ResponseField>
    ...
    <ResponseField name="active" type="number" default={1}>
        Product status

        <Warning>If set to `0`, the product will be considered removed from your Store</Warning>
    </ResponseField>
</Accordion>
